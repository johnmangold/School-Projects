...
int mailbox()
{
	...
	while(true)
	{
		...
		if( input.substr(0,8) == "mboxinit")
		{
			...
			{
				cout << "\nDo not enter numbers in the command." << endl;
				continue;
			}
			...
			if(mbs_num.find_first_not_of("0123456789") != string::npos)
			{
				cout << "\nDo not enter letters in the desired number of mailboxes." << endl;
				continue;
			}
			...
			if(mbs_num.find_first_not_of("0123456789") != string::npos)
			{
				cout << "\nDo not enter letters in the desired size of each mailbox." << endl;
				continue;
			}
		...
		{
			if(input.substr(0,7).find_first_of("0123456789") != string::npos)
			{
				cout << "\nDo not enter numbers in the command." << endl;
				continue;
			}
		...
		else if( input.substr(0,9) == "mboxwrite" )
		{
			...
			if(boxnumber.find_first_not_of("0123456789") != string::npos)
			{
				cout << "\nDo not enter letters in the desired mailbox number." << endl;
				continue;
			}
		...
		else if( input.substr(0,8) == "mboxcopy" )
		{
			...
			if(boxnumber.find_first_not_of("0123456789") != string::npos)
			{
				cout << "\nDo not enter letters in the desired mailbox number to copy from." << endl;
				continue;
			}
			...
			if(boxnumber.find_first_not_of("0123456789") != string::npos)
			{
				cout << "\nDo not enter letters in the desired mailbox number to copy to." << endl;
				continue;
			}
